...
+ 把esp32-04DB14設定靜態IP: 192.168.40.11 XXXX
+ 將esp32-04DB14綁好IP後再設定port forwards XXXX
...
+ ESP32_TxRx_HTTP (x.x.x.x:26201->192.168.40.11:80) **用台灣之星的情況，沒有固定IP這個可能無效** XXX
